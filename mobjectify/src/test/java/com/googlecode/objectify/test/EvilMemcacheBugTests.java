...
public class EvilMemcacheBugTests extends TestBase
{
	...
	public void testEntityKeys() throws Exception
	{
		...
		// remove the ! once the bug has been fixed
	...
	public void testWithoutObjectify()  throws Exception {
		...
		// dump.size() is expected to be 1, but due to gae bug it is not.
		// this test is expected to fail once the bug is fixed and
		// at that point the ! should be removed.
		assert !(dump.size() == 1);
